              ...
              <svg viewBox="0 0 130 32" aria-hidden="true" className="h-8">
                ...
                >
                  <rect
                    ...
                    className="h-8 transition-all duration-300 fill-indigo-950 w-0 group-hover/logo:w-8"
                  ></rect>
                  <use
                    href="#:R6ata:-path"
        ...
        <Container className="py-20 md:py-24">
          <div className="grid grid-cols-12 gap-6 items-center">
            <div className="col-span-12 md:col-span-7 lg:col-span-6">
              <h4 className="text-3xl md:text-4xl/tight font-extrabold text-indigo-950">
