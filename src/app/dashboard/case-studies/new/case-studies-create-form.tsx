...
const FormSchema = z.object({
  ...
  clientLogo: z.any().refine((val) => val, "Client logo is required"),
  services: z.string().trim().min(1, { message: "Services is required" }),
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Client Name" {...field} className="" />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="UX Research, Wireframing, UI Design"
                    {...field}
                    className=""
                  />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="05 Dec 2022 - 01 Jan 2023"
                    {...field}
                    className=""
                  />
                </FormControl>
